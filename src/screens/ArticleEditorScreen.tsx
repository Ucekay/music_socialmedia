...
import type { ToolbarItem } from '@/src/components/RichText/Toolbar/actions';
  ...
  const handlePickArtwork = () => {
    ...
    when(
      ...
      () => {
        ...
        const status = musicItem$.status.get();
        if (url && status === 'selected') {
          editor.setImage(url);
...
const ArticleEditorScreen = observer(() => {
    ...
    <>
      <View style={styles.editorContainer}>
        <View style={styles.editorUnderlay}>
          ...
          >
            <RichText editor={editor} scalesPageToFit style={styles.editor} />
          </Animated.View>
        </View>
      ...
      >
        <BottomSheetView
          style={[styles.bottomSheetContent, { paddingBottom: insets.bottom }]}
        >
...
export default ArticleEditorScreen;
