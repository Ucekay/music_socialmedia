...
export const GetTopChart = async (
  ...
  try {
    const topchartresponce = await new Promise<string[] | undefined>(
      (resolve, reject) => {
...
export const GetPersonalizedrecommendation = async (): Promise<
  string[] | undefined
> => {
  try {
    const personalizedresponce = await new Promise<string[] | undefined>(
      (resolve, reject) => {
