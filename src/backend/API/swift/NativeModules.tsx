...
export const getAuthorizationStatus = requireNativeModule("getAuthorizationStatus")
export const getSubscriptionStatus = requireNativeModule("getSubscriptionStatus")
...
export const GetInformationDetails = requireNativeModule("GetInformationDetails")
...
export const PersonalizedChart = requireNativeModule("fetchPersonalizedRecommendations")