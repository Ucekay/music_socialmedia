...
export class likeDao implements likeRepository {
    ...
    async insertLikeToArticle(articleId: number, userId: string): Promise<boolean> {
        try {
            const { error } = await supabase
                .from('article_likes')
    ...
    async deleteLikeToArticle(articleId: number, userId: string): Promise<boolean> {
        try {
            const { error } = await supabase
                .from('article_likes')
                .delete()
    ...
    async existLikeToArticle(articleId: number, userId: string): Promise<boolean> {
        try {
            const { data, error } = await supabase
                .from('article_likes')
                .select('id')
