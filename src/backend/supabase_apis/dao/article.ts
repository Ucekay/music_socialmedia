...
import type {
  CreateLiveReportParams,
  GetLiveReportDetailRes,
  UpdateLiveReportParams,
} from '../dbdriver/LiveReport';
import type {
  CreatePlaylistArticleParams,
  GetPlaylistArticleDetailRes,
  UpdatePlaylistArticleParams,
} from '../dbdriver/PlaylistArticle';
import type {
  CreateReviewParams,
  GetReviewDetailRes,
  UpdateReviewParams,
} from '../dbdriver/Review';
...
export interface ArticleRepository {
  ...
  getOlderData(
    cursor: string,
  ): Promise<{ articles: ArticleInteg[]; err: Error | null }>;
  getNewerData(
    latestCursor: string,
  ): Promise<{ articles: ArticleInteg[]; err: Error | null }>;
...
export class ArticleDao implements ArticleRepository {
  ...
  public async getInitialData(): Promise<{
    ...
    try {
      const { data: rowArticles, error } = await supabase.rpc(
        'fetch_articles_general_init',
        {},
      );
