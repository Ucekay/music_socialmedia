...
export const insertLiveReport = async (
    Data: Omit<LiveReport, 'LiveReportID' | 'UserID'  | 'likes' |
...
//データ取得関数
export const getLiveReport = async (articleId: number, userID:string): Promise<{LiveReportData:GetGetArticleContent, LikeToArticle:boolean }| null> => {
  try {
