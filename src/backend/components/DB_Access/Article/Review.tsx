...
export const insertReview = async (
    Data: Omit<Review, 'ReviewID' | 'UserID' | 'likes' |
...
//データ取得関数
export const getReview = async (articleId: number, userID:string): Promise<{ReviewData:GetGetArticleContent, LikeToArticle:boolean }| null> => {
  try {
