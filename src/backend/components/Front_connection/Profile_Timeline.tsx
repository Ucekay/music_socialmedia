...
import { getInitialUsersPosts, getOlderUsersPosts, getNewerUsersPosts} from "../DB_Access/post";
import { PostDataType } from "@/src/types";
import { PostData } from "@/src/types";


//最初に表示するポストデータを作成する関数
export const createPostDataset = async (userId: string,prevcursor:string |null, latest:boolean|null) :
