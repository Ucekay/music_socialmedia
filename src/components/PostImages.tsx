  ...
  const OptionModal = (props): JSX.Element => {
    return(
        <View style={[
            ...
            >
                <View style={{flexDirection: 'row', alignItems: 'flex-start', marginTop: 8, flex: 1}}>
                    <Image source={props.userAvatarUrl} style={{ width: 30, height: 30, borderRadius: 15, marginRight: 12 }} />
                    <View style={{ flex: 1 }}>
                        <View
                        style={[
                        ...
                        >
                            <Text style={{color:'#ffffff',fontSize: 14, fontWeight: '500', lineHeight: 16,}}>{props.user}</Text>
                        </View>
                        <View>
                            <Text style={{ color:'#ffffff', fontSize: 14, lineHeight: 20, marginRight: 12, marginBottom: 10, marginTop: 4,}}>{props.postContent}</Text>
                        </View>
                    </View>
                </View>
