...
const Colors: {
  ...
  light: {
    ...
    distractive: chroma(palette.red['500']).hex(),
    distractiveBg: chroma(palette.red['200']).hex(),
    distractiveText: chroma(palette.red['700']).hex(),
  ...
  dark: {
    ...
    distractive: chroma(palette.red['600']).hex(),
    distractiveBg: chroma(palette.red['800']).hex(),
    distractiveText: chroma(palette.red['300']).hex(),
    buttonFilled: chroma(palette.blue['600']).hex(),
