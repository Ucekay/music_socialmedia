  ...
  return (
    ...
    <BgView style={[styles.container]}>
      ...
      <View style={styles.header}>
        <Text style={[styles.headertitle, {color: textColor}]}>返信</Text>
      </View>
      ...
      <View style={styles.editorHeader}>
        <View style={{flexDirection: 'column'}}>
            <Image source={props.userAvatarUrl} style={styles.avatorimage} />
            <Animated1.View 
...
export default RetweetEditorModal
