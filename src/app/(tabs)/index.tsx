...
import { Alert, AppState, View, StyleSheet, Pressable, Text, useWindowDimensions, useColorScheme, TextInput, Button } from 'react-native'
...
export default function TabIndex() {
  ...
  async function HandleSignUp()  {setLoading(true)
    const {
      data: { session },
      error,
